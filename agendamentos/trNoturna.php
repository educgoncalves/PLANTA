...
try {
	...
	if ($_sql->execute()){
		...
		foreach ($_registros as $_dados) {
			...
			gerarVoosPlanejados($identificacaoAeroporto, $_dados['idSite'], $_dados['icao'], $inicio, $final);
			gerarVoosOperacionais($identificacaoAeroporto, $_dados['idSite'], $_dados['icao'], $dtMovimento);
		}
	} 
