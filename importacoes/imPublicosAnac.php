...
if ($evento == "importar") {
    ...
    executarImportacaoPublicosAnac($identificacao,$_SESSION['plantaUsuario'], 'MNL');

    // Verifica se tem arquivo log gerado
    $log = lerXLogProcesso('../logs/trPublicosAnac_'.$identificacao.'.txt');
...
formulario:
metaTagsBootstrap('');
$titulo = "Importar Aeródromos Públicos da ANAC";
?>
<head>
...
<div id="container">
    ...
    <div class="container alert alert-padrao" >
        <form action="?evento=importar" method="POST" class="form-inline" action="" enctype="multipart/form-data" onsubmit="$('.carregando').show();">
            ...
            <?php destacarTarefaPublicosANAC(); ?>  
            <!-- <div class="row pt-2 px-2"> 
