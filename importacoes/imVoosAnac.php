...
if ($evento == "importar") {
    ...
    executarImportacaoVoosAnac($identificacao,$_SESSION['plantaUsuario'], 'MNL');

    // Verifica se tem arquivo log gerado
    $log = lerXLogProcesso('../logs/trVoosAnac_'.$identificacao.'.txt');
...
formulario:
metaTagsBootstrap('');
$titulo = "Importar Voos Regulares da ANAC";
?>
<head>
