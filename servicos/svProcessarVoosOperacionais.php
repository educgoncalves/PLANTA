...
if ($evento == "executar") {
    ...
    processarVoosOperacionais($identificacao, $aeroporto, $usuario, 'MNL');

    // Verifica se tem arquivo log gerado
    $log = lerXLogProcesso('../logs/trProcessarVoosOperacionais_'.$identificacao.'.txt');
...
formulario:
metaTagsBootstrap('');
$titulo = "Processar Voos Operacionais";
?>
<head>
            ...
            <div class="row">  
                <div class ="col-lg-10">
                    <div class="row pt-2 px-2">            
                        <?php
                            echo "<p class='text-justify'>Executa o processamento dos voos operacionais.";
